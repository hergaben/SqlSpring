...
public class SqlSpringApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		for (Element element:elements) {
			...
			Element img1 = page.select("img[data-src]").get(1);
			Element img2 = page.select("img[data-src]").get(2);
			Element img3 = page.select("img[data-src]").get(3);
			Element img4 = page.select("img[data-src]").get(4);
			Element img5 = page.select("img[data-src]").get(5);
			...
			String score1 = page.getElementsByClass("score").get(1).text();
			String score2 = page.getElementsByClass("score").get(2).text();
			String score3 = page.getElementsByClass("score").get(3).text();
			String score4 = page.getElementsByClass("score").get(4).text();
			String score5 = page.getElementsByClass("score").get(5).text();
